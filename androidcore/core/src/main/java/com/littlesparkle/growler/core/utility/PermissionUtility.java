...
public class PermissionUtility {
    ...
    public static boolean hasPermissions(Context context, String perm) {
            ...
            if (rationale == null) {
                ...
                AlertDialog dialog = new AlertDialog.Builder(getActivity(object))
                        ...
                        .setNegativeButton(negativeButton, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                // Do nothing, mBaseUser does not want to request
    ...
    public static void requestPermissionsNoNegativeButton(final Object object, final PermissionListener listener, String rationale, @StringRes int positiveButton,
                                                          final String... perms) {
        checkCallingObjectSuitability(object);
    ...
    public static void onRequestPermissionsResult(Object object, PermissionListener callbacks, int requestCode, String[] permissions,
        ...
        if (requestCode == RUNTIME_PERMISSION) {
            ...
            if (!denied.isEmpty()) {
                ...
                callbacks.onAllPermissionGranted();
            }
        }
    }
