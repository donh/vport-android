...
import com.a21vianet.quincysx.library.crypto.utils.Utils;
...
import static com.a21vianet.quincysx.library.crypto.script.Script.MAX_SCRIPT_ELEMENT_SIZE;
...
import static com.a21vianet.quincysx.library.crypto.script.ScriptOpCodes.OP_16;
...
import static com.a21vianet.quincysx.library.crypto.script.ScriptOpCodes.getOpCodeName;
import static com.a21vianet.quincysx.library.crypto.script.ScriptOpCodes.getPushDataName;
import static com.a21vianet.quincysx.library.crypto.guava.Preconditions.checkNotNull;
...
public class ScriptChunk {
    ...
    /**
     * Called on a pushdata chunk, returns true if it uses the smallest possible way (according
     * to BIP62) to push the data.
     */
    ...
    static int decodeFromOpN(int opcode) {
        checkArgument((opcode == OP_0 || opcode == OP_1NEGATE) || (opcode >= OP_1 && opcode <=
                OP_16), "decodeFromOpN called on non OP_N opcode");
        if (opcode == OP_0)
            return 0;
