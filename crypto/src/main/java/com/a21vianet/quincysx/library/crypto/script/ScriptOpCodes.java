...
/**
 * Various constants that define the assembly-like scripting language that forms part of the
 * Bitcoin protocol.
 */
...
//    private static final Map<String, Integer> opCodeNameMap = new HashMap();
//            .put("0", OP_0)
